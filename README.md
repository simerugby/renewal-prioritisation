...
is 5 of those 100 points, so dropping it on its own leaves 95% of the weight applied, which is not enough to
...
schema.** Company two's export has different columns and unseen enum values, and that is a real fixture in
